...
public class L3CondFormImpl extends ASTWrapperPsiElement implements L3CondForm {

  public L3CondFormImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull L3Visitor visitor) {
    visitor.visitCondForm(this);
  }
  ...
  @Override
  @NotNull
  public List<L3CondClause> getCondClauseList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, L3CondClause.class);
  }
