...
public class L3PrimNameRefImpl extends ASTWrapperPsiElement implements L3PrimNameRef {

  public L3PrimNameRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull L3Visitor visitor) {
    visitor.visitPrimNameRef(this);
  }
