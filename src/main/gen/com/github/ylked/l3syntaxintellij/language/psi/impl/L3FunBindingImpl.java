...
public class L3FunBindingImpl extends ASTWrapperPsiElement implements L3FunBinding {

  public L3FunBindingImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull L3Visitor visitor) {
    visitor.visitFunBinding(this);
  }
  ...
  public L3FunForm getFunForm() {
    return findNotNullChildByClass(L3FunForm.class);
  }
