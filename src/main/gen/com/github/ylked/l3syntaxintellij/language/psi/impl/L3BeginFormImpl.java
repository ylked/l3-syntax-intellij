...
public class L3BeginFormImpl extends ASTWrapperPsiElement implements L3BeginForm {

  public L3BeginFormImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull L3Visitor visitor) {
    visitor.visitBeginForm(this);
  }
